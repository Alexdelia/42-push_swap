...
/*   Updated: 2021/03/23 21:07:52 by adelille         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	ft_dor(t_arg *arg, char *line)
{
	...
	if (ft_strcmp(line, "ra") == 0)
		err = ft_ra(arg->a) + ft_lst_color(arg, ft_lstsize(arg->a), 0);
	else if (ft_strcmp(line, "rb") == 0)
		err = ft_rb(arg->b) + ft_lst_color(arg, 0, ft_lstsize(arg->b));
	else if (ft_strcmp(line, "rr") == 0)
		err = ft_ra(arg->a) + ft_rb(arg->b)
			+ ft_lst_color_a(arg, ft_lstsize(arg->a), ft_lstsize(arg->b));
	else if (ft_strcmp(line, "rra") == 0)
		err = ft_rra(arg->a) + ft_lst_color(arg, 1, 0);
	else if (ft_strcmp(line, "rrb") == 0)
		err = ft_rrb(arg->b) + ft_lst_color(arg, 0, 1);
	else if (ft_strcmp(line, "rrr") == 0)
		err = ft_rra(arg->a) + ft_rrb(arg->b) + ft_lst_color(arg, 1, 1);
	else
	{
		err = 1;
...
int	ft_doop(t_list *arg, char *line)
{
	int	err;
